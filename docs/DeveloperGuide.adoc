...
`DetailsPanel` is TabPane which consists of the following tabs:
// tag::tabs[]
****
* `Contact Details`
* `LinkedIn Search`
...
image::SwitchTabRequestEventHighSD.png[align="center"]
...
image::SwitchTabRequestEventSD.png[align="center"]
...
image::SwitchTabRequestEventSD2.png[align="center"]
...
image::SDforAddJobEventHandling.png[align="center"]
...
.UML class diagram for Job Opening
image::Auto-CompleteActivityDiagram.png[align="center"]
